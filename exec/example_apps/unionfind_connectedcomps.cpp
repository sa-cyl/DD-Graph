...
size_t ne = 0;
 ...
 class UnionFindVertex : public ddgraph_vertex<VertexDataType, EdgeDataType> {
public:
    
        
    UnionFindVertex() : ddgraph_vertex<VertexDataType, EdgeDataType> () {}
    ...
    UnionFindVertex(vid_t _id, 
                      ...
                      int indeg, 
                      int outdeg) : 
    ddgraph_vertex<VertexDataType, EdgeDataType> (_id, NULL, NULL, indeg, outdeg) { 
    }
...
struct UnionFindProgram : public GraphChiProgram<VertexDataType, EdgeDataType, UnionFindVertex> {
     ...
     */
    void update(UnionFindVertex &vertex, ddgraph_context &gcontext) {
     ...
     */
    void before_exec_interval(vid_t window_st, vid_t window_en, ddgraph_context &gcontext) {        
    }
    
    /**
     * Called after an execution interval has finished.
     */
    void after_exec_interval(vid_t window_st, vid_t window_en, ddgraph_context &gcontext) {        
    }
...
int main(int argc, const char ** argv) {
    ...
    ddgraph_engine<VertexDataType, EdgeDataType, UnionFindVertex > engine(filename, nshards, false, m); 
