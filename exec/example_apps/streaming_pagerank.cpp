...
ddgraph_dynamicgraph_engine<float, float> * dyngraph_engine;
...
int main(int argc, const char ** argv) {
    ...
    dyngraph_engine = new ddgraph_dynamicgraph_engine<float, float>(filename, nshards, scheduler, m); 
    ...
    /* Start HTTP admin */
    start_httpadmin< ddgraph_dynamicgraph_engine<float, float> >(dyngraph_engine);
