...
static void VARIABLE_IS_NOT_USED remove_edgev(ddgraph_edge<bidirectional_label> * e);
static void VARIABLE_IS_NOT_USED remove_edgev(ddgraph_edge<bidirectional_label> * e) {
...
int main(int argc, const char ** argv) {
    ...
    while(remainingvertices) {
        ...
        ddgraph_engine<VertexDataType, EdgeDataType> engine(filename, nshards, scheduler, m); 
        if (first_iteration) {
        ...
        if (remainingvertices) {
            ...
            ddgraph_engine<VertexDataType, EdgeDataType> engine2(filename, nshards, scheduler, m); 
