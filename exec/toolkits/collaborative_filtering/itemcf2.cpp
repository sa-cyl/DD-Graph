...
class adjlist_container {
   ...
   */
  int load_edges_into_memory(ddgraph_vertex<uint32_t, float> &v) {
   ...
   */
  double calc_distance(ddgraph_vertex<uint32_t, float> &v, vid_t pivot, int distance_metric) {
