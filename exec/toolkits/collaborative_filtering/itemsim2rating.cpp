...
class adjlist_container {
  public:
     ...
     */
    int load_edges_into_memory(ddgraph_vertex<uint32_t, EdgeDataType> &v) {
     ...
     *
     */
    double compute_ratings(ddgraph_vertex<uint32_t, EdgeDataType> &item, vid_t user_pivot, int distance_metric) {
...
int main(int argc, const char ** argv) {
  ...
  ddgraph_engine<VertexDataType, EdgeDataType> engine(training,nshards, true, m); 
