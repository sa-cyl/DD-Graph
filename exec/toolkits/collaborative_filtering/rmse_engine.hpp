...
void init_validation_rmse_engine(ddgraph_engine<VertexDataType,EdgeDataType> *& pvalidation_engine, int nshards,float (*prediction_func)(const vertex_data & user, const vertex_data & movie, float rating, double & prediction, void * extra)){
  if (nshards == -1)
    return;
...
template<typename VertexDataType, typename EdgeDataType>
void run_validation(ddgraph_engine<VertexDataType, EdgeDataType> * pvalidation_engine, ddgraph_context & context){
