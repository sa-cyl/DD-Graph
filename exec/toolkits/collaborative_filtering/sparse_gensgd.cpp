...
ddgraph_engine<VertexDataType, EdgeDataType> * pengine = NULL; 
...
void training_rmse_N(int iteration, ddgraph_context &gcontext, bool items = false){
...
int main(int argc, const char ** argv) {
  ...
  ddgraph_engine<VertexDataType, EdgeDataType> engine(training, nshards, false, m); 
