...
class adjlist_container {
   ...
   */
  int load_edges_into_memory(ddgraph_vertex<VertexDataType, EdgeDataType> &v) {
   ...
   */
  double calc_distance(ddgraph_vertex<VertexDataType, EdgeDataType> &v, vid_t pivot, int distance_metric) {
