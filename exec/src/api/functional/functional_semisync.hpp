...
class functional_vertex_unweighted_semisync : public ddgraph_vertex<typename KERNEL::VertexDataType, typename KERNEL::EdgeDataType> {
public:
    ...
    functional_vertex_unweighted_semisync() : ddgraph_vertex<VT, ET> () {}
    
    functional_vertex_unweighted_semisync(ddgraph_context &ginfo, vid_t _id, int indeg, int outdeg) : 
    ...
    void first_iteration(ddgraph_context &gcontext_) {
    ...
    void ready(ddgraph_context &gcontext_) {
