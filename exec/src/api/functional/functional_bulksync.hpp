...
namespace ddgraph {
    ...
    class functional_vertex_unweighted_bulksync : public ddgraph_vertex<typename KERNEL::VertexDataType, PairContainer<typename KERNEL::EdgeDataType> > {
    public:
        ...
        functional_vertex_unweighted_bulksync() : ddgraph_vertex<VT, ET> () {}
        
        functional_vertex_unweighted_bulksync(ddgraph_context &ginfo, vid_t _id, int indeg, int outdeg) : 
        ddgraph_vertex<VT, ET> (_id, NULL, NULL, indeg, outdeg) { 
        ...
        functional_vertex_unweighted_bulksync(vid_t _id, 
                                              ddgraph_edge<ET> * iptr, 
                                              ddgraph_edge<ET> * optr, 
                                              int indeg, 
                                              int outdeg) {
            assert(false); // This should never be called.
        }
        
        void first_iteration(ddgraph_context &ginfo) {
        ...
        void ready(ddgraph_context &ginfo) {
    ...
    public:  
         ...
         */
        void update(fvertex_t &v, ddgraph_context &ginfo) {
