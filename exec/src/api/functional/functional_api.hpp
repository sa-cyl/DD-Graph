    ...
    /**
     ...
     struct functional_kernel {
        ...
        /* Initial value - on first iteration */
         virtual VertexDataType initial_value(ddgraph_context &info, vertex_info& myvertex) = 0;        
        /* Called before first "gather" */
         virtual VertexDataType reset()  = 0;        
        // Note: Unweighted version, edge value should also be passed
        // "Gather"
        virtual EdgeDataType op_neighborval(ddgraph_context &info, vertex_info& myvertex, vid_t nbid, EdgeDataType nbval)= 0;         
        // "Sum"
        virtual EdgeDataType plus(VertexDataType curval, EdgeDataType toadd) = 0;
         // "Apply"
        virtual VertexDataType compute_vertexvalue(ddgraph_context &ginfo, vertex_info& myvertex, EdgeDataType nbvalsum) = 0;        
        // "Scatter
        virtual EdgeDataType value_to_neighbor(ddgraph_context &info, vertex_info& myvertex, vid_t nbid, VertexDataType myval) = 0;        
    }; 
