...
namespace ddgraph {
    ...
    template <typename VertexDataType_, typename EdgeDataType_,
                typename vertex_t = ddgraph_vertex<VertexDataType_, EdgeDataType_> >
    ...
    public:
         ...
         */
        virtual bool repeat_updates(ddgraph_context &gcontext) {
            return false;
        }
         ...
         * Update function.
         */
        virtual void update(vertex_t &v, ddgraph_context &gcontext)  = 0;    
    };
