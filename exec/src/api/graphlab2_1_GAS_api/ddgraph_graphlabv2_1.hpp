...
namespace graphlab {
    ...
    public:
        ...
        /* GraphChi */
        ddgraph_context * gcontext;
        
        
        
    public:        
        
        icontext(ddgraph_context * gcontext) : gcontext(gcontext) {}
    ...
    struct distributed_graph {
        ...
        typedef ddgraph::vid_t vertex_id_type;
    };
    ...
    struct ivertex_program {
        ...
        typedef typename ddgraph::vid_t vertex_id_type;
        typedef GraphLabVertexWrapper<vertex_data_type, edge_data_type> vertex_type;
        typedef GraphLabEdgeWrapper<vertex_data_type, edge_data_type> edge_type;
    ...
    template <typename GLVertexDataType, typename EdgeDataType>
    struct GraphLabEdgeWrapper {
        typedef ddgraph_vertex<bool, EdgeDataType> VertexType;
        typedef GLVertexDataType vertex_data_type;
        typedef EdgeDataType edge_data_type;
        typedef GraphLabVertexWrapper<GLVertexDataType, EdgeDataType> vertex_type;

        ddgraph_edge<EdgeDataType> * edge;
        VertexType * vertex;
        std::vector<GLVertexDataType> * vertexArray;
        bool is_inedge;
        
        GraphLabEdgeWrapper(ddgraph_edge<EdgeDataType> * edge, VertexType * vertex,
    ...
    struct GraphLabWrapper : public GraphChiProgram<bool, typename GraphLabVertexProgram::edge_data_type> {
         ...
         */
        virtual void before_iteration(int iteration, ddgraph_context &gcontext) {
         ...
         */
        virtual void after_iteration(int iteration, ddgraph_context &gcontext) {
        }
        
        /**
         * Called before an execution interval is started.
         */
        virtual void before_exec_interval(vid_t window_st, vid_t window_en, ddgraph_context &gcontext) {        
        }
        
        /**
         * Called after an execution interval has finished.
         */
        virtual void after_exec_interval(vid_t window_st, vid_t window_en, ddgraph_context &gcontext) {        
        }
        
        /**
         * Update function.
         */
        void update(ddgraph_vertex<bool, EdgeDataType> &vertex, ddgraph_context &gcontext) {
...
template <typename GraphLabVertexProgram>
    ...
    ddgraph_engine<bool, typename GLWrapper::EdgeDataType> engine(base_filename, nshards, scheduler, _m); 
...
ReductionType run_graphlab_edge_aggregator(std::string base_filename, int nshards,
    ...
    ddgraph_engine<bool, typename GLEdgeAggrWrapper::EdgeDataType> engine(base_filename, nshards, true, _m); 
