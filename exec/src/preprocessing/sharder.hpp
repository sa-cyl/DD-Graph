        ...
        void create_degree_file() {
            ...
            for(int window=0; window<nshards; window++) {
                ...
                for(vid_t subinterval_st=interval_st; subinterval_st <= interval_en; ) {
                    ...
                    std::vector< ddgraph_vertex<int, dummy_t> > vertices(nvertices, ddgraph_vertex<int, dummy_t>()); // preallocate
                    
                    
                    for(int i=0; i < nvertices; i++) {
                        vertices[i] = ddgraph_vertex<int, dummy_t>(subinterval_st + i, NULL, NULL, 0, 0);
