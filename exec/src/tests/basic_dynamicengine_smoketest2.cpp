 ...
 * @section DESCRIPTION
 *
 * Simple smoketest for the dynamic graph ddgraph engine.
 */
    ...
    void update(ddgraph_vertex<VertexDataType, EdgeDataType> &vertex, ddgraph_context &gcontext) {
        ...
        if (gcontext.iteration == 0) {
            ...
            for(int i=0; i < vertex.num_outedges(); i++) {
                ddgraph_edge<vid_t> * edge = vertex.outedge(i);
...
int main(int argc, const char ** argv) {
    ...
    ddgraph_dynamicgraph_engine<VertexDataType, EdgeDataType> engine(filename, nshards, scheduler, m); 
