...
namespace ddgraph {
    ...
    class functional_engine : public ddgraph_engine<VertexDataType, EdgeDataType,  fvertex_t> {
    public:
        functional_engine(std::string base_filename, int nshards, bool selective_scheduling, metrics &_m) :
        ddgraph_engine<VertexDataType, EdgeDataType, fvertex_t>(base_filename, nshards, selective_scheduling, _m){
    ...
    protected:
        ...
        virtual void init_vertices(std::vector<fvertex_t> &vertices, ddgraph_edge<EdgeDataType> * &e) {
